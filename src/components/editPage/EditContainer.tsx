...
function EditContainer() {
  ...
  useEffect(() => {
    ...
    if (userName !== null) setNickname(userName);
    if (userProfile !== null) setProfileImg(userProfile);
  }, []);
    ...
    <SignupContainer>
      ...
      <FormBox onSubmit={onSubmit}>
        <SignupBox>
          ...
          <SignBox2>
            <CheckBox>
              <div className="check_pr">중복확인을 꼭 눌러주세요~</div>
              <div>
                <InputSt
                  type="text"
        ...
        <SubmitBtn>
          <input
            type="submit"
            value="확인"
            disabled={!(isNickname && nickCheck && realCheck)}
          />
        </SubmitBtn>
      </FormBox>
    </SignupContainer>
